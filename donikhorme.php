...
<html lang="en-US">
    <head>
        ...
        <link rel='stylesheet' id='donik-main-css' href='https://donikdemo.boomdevstheme.com/wp-content/themes/donik/css/style.css?ver=1723614675' type='text/css' media='all'/>
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a class="standard-logo" href="#">
                        <img src="https://cep.yowza.co.za/images/community-engagement-platform_-logo_v4-1.png" alt="logo" style="max-width: 120px; height: auto;" />
                    </a>
                </div>
                <div class="menu d-inline-block">
                    <nav id="main-menu" class="main-menu">
                        <ul id="menu-main-menu" class="">
                            <li class="menu-item nav-item"><a title="Home" href="#" class="nav-link-menu">Home</a></li>
                            <li class="menu-item nav-item"><a title="Get In Touch" href="#" class="nav-link-menu">Get In Touch</a></li>
                            <li class="menu-item nav-item"><a title="Sign In" href="#" class="nav-link-menu">Sign In</a></li>
                            <li class="menu-item nav-item"><a title="Register" href="#" class="nav-link-menu">Register</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
                                                            ...
                                                            <div class="col-lg-6 align-self-center order-2 order-md-1">
                                                                <div class="slider-content-wrapper">
                                                                    <div class="slider-content">
                                                                        <span class="slider-short-title">Your voice, platform and opportunity to connect </span>
                ...
                <div class="elementor-container elementor-column-gap-default">
                    ...
                    <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-61ebfba about-us-content-wrapper" data-id="61ebfba" data-element_type="column">
                        <div class="elementor-widget-wrap elementor-element-populated">
							...
							<h2 class="title">Community Engagement Platform</h2>
			
								<p class="desc">Your voice, platform and opportunity to connect 
                                                ...
                                                <div class="elementor-widget-container">
                                                    <div class="about-info-card">
                                                        ...
                                                        <div class="content-wrapper">
                                                            <h5 class="title">Who Is Siyakha</h5>
                    ...
                    <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-71f203a" data-id="71f203a" data-element_type="column">
                        <div class="elementor-widget-wrap elementor-element-populated">
                            <div class="elementor-element elementor-element-0d781ee elementor-align-left elementor-widget elementor-widget-donik-header" data-id="0d781ee" data-element_type="widget" data-widget_type="donik-header.default">
                                <div class="elementor-widget-container">
                                    <div class="section-title">
                                        <span class="short-title">Overall Impact on Communities</span>
                                        <h2 class="title">
                                            Your voice,<br> platform and opportunity to connect 
                                        </h2>
                                    </div>
                                </div>
                            </div>
                                                            ...
                                                            <div class="row gy-4">
                                                                ...
                                                                <div class="col-lg-4 col-md-6 col-12">
                                                                    <div class="service-item">
                                                                        ...
                                                                        <div class="service-content">
                                                                            <h5 class="title">Innovation & Technology Adoption
                                                                            </h5>
                                                                            <p class="decs">Lorem ipsum dolor sit amet care about consectetur. Sit donec adipiscing our habitant malesuada iaculis.</p>
                                                                        </div>
                                                                    </div>
                                            ...
                                            <div class="elementor-element elementor-element-7c19a80 elementor-mobile-align-left elementor-widget-tablet__width-initial elementor-align-left elementor-widget elementor-widget-donik-header" data-id="7c19a80" data-element_type="widget" data-widget_type="donik-header.default">
                                                <div class="elementor-widget-container">
                                                    <div class="section-title">
                                                        ...
                                                        <h1 class="title">
                                                            Actively engage around the needs of each community</h1>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="elementor-widget-wrap elementor-element-populated">
                                            <div class="elementor-element elementor-element-971cfcb elementor-mobile-align-left elementor-widget-tablet__width-initial elementor-tablet-align-left elementor-align-left elementor-widget elementor-widget-donik-header" data-id="971cfcb" data-element_type="widget" data-widget_type="donik-header.default">
                                                <div class="elementor-widget-container">
                                                    <div class="section-title">
                                                        <div class="section-title">
                                                            <span class="short-title">With this information, the CEP allows community members</span>
                                                            <p class="desc">“ ​To publish security alerts​ have an active marketplace that advertises small business promotions, specials so that communities support their own SMME’s ​ Provide knowledge and information and public meetings, forums and announcements ​”</p>
                                                        </div>
                        ...
                        <div class="mc4wp-form-fields">
                            <div class="single-field">
                                ...
                                <form id="mc4wp-form-1" class="mc4wp-form mc4wp-form-1486" method="post" data-id="1486" data-name="">
                                    ...
                                    <input type="hidden" name="_mc4wp_timestamp" value="1723614675"/>
