...
<div class="container">
    ...
    <form method="POST" action="{{ route('signup.step2.post') }}">
        @csrf
        ...
        <div id="extension-diepsloot" class="form-group" style="display: none;">
        ...
        <div id="extension-alexander" class="form-group" style="display: none;">
        ...
        <div id="extension-soweto" class="form-group" style="display: none;">
